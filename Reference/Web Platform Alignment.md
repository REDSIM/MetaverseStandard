...
| Audio, video, and capture | [Media Capture](https://www.w3.org/TR/mediacapture-streams/), [Web Audio](https://www.w3.org/TR/webaudio/), [WebRTC](https://www.w3.org/TR/webrtc/) | Preserve media creation, playback, communication, and consent use cases; specify media interfaces, codec profiles, and background routing |
